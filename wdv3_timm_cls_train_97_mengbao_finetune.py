...
def main():
    ...
    model_name = f'l_mengbao_ft_cls_4_{Mengbao_person_id_nums}_{time.time()}'
    ...
    # # resume
    resume_path = '/data/liuhaoxiang/data_97/experiments/wdv3_cls/l_mengbao_ft/model/model_epoch_1_no_frozen_model.pth'
